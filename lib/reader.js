			...
			paths: _(blocks)
				...
				.mapValues(path => _(path)
					...
					.mapValues(b => {
						...
						debug('OAPI pre-spec', b)

						if (b.route.path.includes('test')) {
							const category = b.category[0].description;

							b.tags = [category];
							// b.description = "Injected name for test api docs!"

							console.log('OAPI pre-spec:', b, b.category, b.category[0].description)
						}
