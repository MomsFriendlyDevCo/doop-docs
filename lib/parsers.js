...
const debug = require('debug')('docs:parsers');
...
module.exports = {
	...
	// TODO: Uncommenting this results in error in widdershins: <??>.split is not a function
	...
	*/
	...
	// Splits inputted text into an array of words, splitting by spaces and commas
	words(line) {
		debug('Parsing (words):', line);
		return line.split(/[\s,]+/);
	},
